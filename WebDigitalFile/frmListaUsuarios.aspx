<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmListaUsuarios.aspx.cs" Inherits="WebDigitalFile.frmListaUsuarios" %>
...
<link href="css/Prodac.css" rel="stylesheet" />
    ...
    <form id="frm_Listausuarios" runat="server">
        ...
        <div id="div_filtro" class="row">
            <div class="col-1" >
              ...
              <div class="col-1" >
                        <asp:Label ID="Label6" style="color:blue"  runat="server" Text="Código"></asp:Label>
                        <asp:TextBox ID="txt_Codigo" runat="server" CssClass="textbox_100" Width="100px" MaxLength="15" onKeyPress=" return SoloNumeros(event)" />
                        <asp:Label ID="Label8" style="color:#CCCCCC"  runat="server" Text="." EnableTheming="True"></asp:Label>
                        <asp:HiddenField ID="hdn_cod" runat="server" />
                </div>
            <div class="col-3" >
                        <asp:Label ID="Label7" style="color:blue"  runat="server" Text="Nombre"></asp:Label>
                        <asp:TextBox ID="txt_Nombre" runat="server" CssClass="textbox_100" Width="290px" MaxLength="100"  />
             </div>
            <div class="col-1" >
                        <asp:Label ID="Label10" style="color:blue"  runat="server" Text="Tipo Trabajador"></asp:Label>
                        <asp:DropDownList ID="ddl_TipoTrabajador" runat="server" CssClass="dropdownlist" Width="100px" Height="23px" />
             </div>

             <div class="col-1" >
                        <asp:Label ID="Label9" style="color:blue"  runat="server" Text="Doc. Identidad"></asp:Label>
                        <asp:TextBox ID="txt_NumDoc" runat="server" CssClass="textbox_100" Width="100px" MaxLength="10" onKeyPress=" return SoloNumeros(event)"  />
             </div>
            <div class="col-1" >
                <asp:Label ID="Label11" style="color:blue"  runat="server" Text="Usuario"></asp:Label>
                <asp:TextBox ID="txt_Usuario" runat="server" CssClass="textbox_100" Width="100px" MaxLength="50"   />
             </div>
             <div class="col-1" >
                        <div>&nbsp;</div>
                        <asp:CheckBox ID="chkActivo" runat="server" Font-Size="11px"  Text="  Activo" ForeColor="#003399" style="cursor:pointer;"/>
             </div>

             <div class="col-2" >
                <div>&nbsp;</div>
                <asp:CheckBox ID="chkGenerarClave" runat="server" Font-Size="11px"  Text="  Cambiar Contraseña" ForeColor="#003399" style="cursor:pointer;"/>
             </div>
             <div class="col-1">
             </div>
       </div>
